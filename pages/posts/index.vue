    ...
    <div class="row py-5 justify-content-center">
      <div class="col-lg-12 text-center pb-4">
        <form class="row g-3 justify-content-center" @submit="serchPost">
          ...
          <div class="col-auto">
            <select v-model="selectedFilter" @change="applyFilter" class="form-select post-input">
          ...
          <div class="col-auto" v-if="selectedCategory">
            <select v-model="selectedSubCategory" @change="applyFilter" class="form-select post-input">
...
const applyFilter = () => {
  ...
  if (selectedSubCategory.value) {
    console.log('Selected Subcategory', selectedSubCategory.value.toLowerCase());
    tempPosts = tempPosts.filter(article => {
      return article.tags && article.tags.some(tag => tag.includes(selectedSubCategory.value.toLowerCase()));
    });
  }
